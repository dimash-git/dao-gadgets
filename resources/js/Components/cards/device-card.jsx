...
export const DeviceCard = ({ device }) => {
    // в пропсе device есть инфа о девайсе
    return (
        <div
            ...
            style={{ backgroundImage: `url(${device?.icon ?? DeviceIcon})` }} // если есть иконка в девайсе бэкграунд ставим на нем, иначе используем дефолт DeviceIcon
        >
